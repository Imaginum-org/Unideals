...
function AuthBrandLogo() {
  return (
    <Link
      to="/"
      className="inline-flex items-center justify-center gap-2.5 sm:gap-3 font-poppins text-xl font-semibold text-white md:gap-1.5 md:text-sm md:text-[#012436] dark:md:text-white lg:gap-2 lg:text-sm xl:gap-2 xl:text-base 2xl:gap-2.5 2xl:text-lg"
    >
      <img
        src={cmlogo}
